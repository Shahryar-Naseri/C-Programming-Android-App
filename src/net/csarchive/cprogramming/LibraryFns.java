...
public class LibraryFns extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFileList();
		l = getListView();
		final ArrayAdapter<String> adapter = new ArrayAdapter<String>(LibraryFns.this, android.R.layout.simple_list_item_1, items);
	...
	private void getFileList() {
		...
		String[] filelist;
		try {
			filelist = assetManager.list("Library Functions");
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		int p = position;
		Intent i = new Intent(LibraryFns.this, LibraryFnsPrograms.class);
		i.putExtra("KEY", p);
		startActivity(i);
	}
