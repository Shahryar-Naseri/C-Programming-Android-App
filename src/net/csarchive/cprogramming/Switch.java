...
public class Switch extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFileList();
		l = getListView();
		adapter = new ArrayAdapter<String>(Switch.this, android.R.layout.simple_list_item_1, items);
