...
public class Others extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFileList();
		l = getListView();
		adapter = new ArrayAdapter<String>(Others.this, R.layout.simple_list_item_1, items);
	...
	private void getFileList() {
		...
		String[] filelist;
		try {
			filelist = assetManager.list("Programs/Others");
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i = new Intent(Others.this, OthersPrograms.class);
		i.putExtra("KEY", str);
		startActivity(i);
	}
