...
public class AllPrograms extends Activity implements View.OnClickListener{
	...
	private void openFile() {
		...
		try {
			InputStream is = am.open("Programs/All/" + temp + ".c");
	...
	private void programOutput() {
		Bundle extras = getIntent().getExtras();
		String temp = "Programs/All output/" + extras.getString("KEY");
		Intent i = new Intent(AllPrograms.this, Output.class);
		i.putExtra("KEY", temp);
		startActivity(i);
	}
	...
	private void saveProgram() {
		...
		try {
				is = am.open("Programs/All/" + temp + ".c");
