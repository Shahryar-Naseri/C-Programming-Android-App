...
public class ConditionalPrograms extends Activity implements View.OnClickListener{
	...
	private void openFile() {
		...
		try {
			InputStream is = am.open("Programs/Conditional Operators/" + temp + ".c");
...
private void syntaxHighlight() {
	...
	private void programOutput() {
		Bundle extras = getIntent().getExtras();
		String temp = "Programs/Conditional Operators output/" + extras.getString("KEY");
	...
	private void saveProgram() {
		...
		try {
				is = am.open("Programs/Conditional Operators/" + temp + ".c");
