...
public class Pointer extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFileList();
		l = getListView();
		final ArrayAdapter<String> adapter = new ArrayAdapter<String>(Pointer.this, android.R.layout.simple_list_item_1, items);
	...
	private void getFileList() {
		...
		String[] filelist;
		try {
			filelist = assetManager.list("Pointer");
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		int p = position;
		Intent i = new Intent(Pointer.this, PointerPrograms.class);
		i.putExtra("KEY", p);
		startActivity(i);
	}
