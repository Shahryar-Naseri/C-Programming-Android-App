...
public class ArrayPrograms extends Activity implements View.OnClickListener{
	...
	private void openFile() {
		...
		try {
			InputStream is = am.open("Programs/Array/" + temp + ".c");
	...
	private void programOutput() {
		Bundle extras = getIntent().getExtras();
		String temp = "Programs/Array output/" + extras.getString("KEY");
	...
	private void saveProgram() {
		...
		try {
				is = am.open("Programs/Array/" + temp + ".c");
