...
public class LinkedList extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFileList();
		l = getListView();
		final ArrayAdapter<String> adapter = new ArrayAdapter<String>(LinkedList.this, android.R.layout.simple_list_item_1, items);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		int p = position;
		Intent i = new Intent(LinkedList.this, LinkedListPrograms.class);
		i.putExtra("KEY", p);
		startActivity(i);
	}
