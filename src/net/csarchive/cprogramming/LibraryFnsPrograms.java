...
public class LibraryFnsPrograms extends Activity implements View.OnClickListener{
	...
	private void openFile() {
		...
		try {
			InputStream is = am.open("Programs/Library Functions/" + temp + ".c");
	...
	private void programOutput() {
		Bundle extras = getIntent().getExtras();
		String temp = "Programs/Library Functions output/" + extras.getString("KEY");
	...
	private void saveProgram() {
		...
		try {
				is = am.open("Programs/Library Functions/" + temp + ".c");
