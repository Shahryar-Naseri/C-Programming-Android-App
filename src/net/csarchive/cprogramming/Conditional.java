...
public class Conditional extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFileList();
		l = getListView();
		adapter = new ArrayAdapter<String>(Conditional.this, R.layout.simple_list_item_1, items);
	...
	private void getFileList() {
		...
		String[] filelist;
		try {
			filelist = assetManager.list("Programs/Conditional Operators");
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i = new Intent(Conditional.this, ConditionalPrograms.class);
		i.putExtra("KEY", str);
		startActivity(i);
	}
