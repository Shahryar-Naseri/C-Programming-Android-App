...
public class PString extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFileList();
		l = getListView();
		adapter = new ArrayAdapter<String>(PString.this, R.layout.simple_list_item_1, items);
	...
	private void getFileList() {
		...
		String[] filelist;
		try {
			filelist = assetManager.list("Programs/String");
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i = new Intent(PString.this, PStringPrograms.class);
		i.putExtra("KEY", str);
		startActivity(i);
	}
