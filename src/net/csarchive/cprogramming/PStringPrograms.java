...
public class PStringPrograms extends Activity implements View.OnClickListener{
	...
	private void openFile() {
		...
		try {
			InputStream is = am.open("Programs/String/" + temp + ".c");
	...
	private void programOutput() {
		Bundle extras = getIntent().getExtras();
		String temp = "Programs/String output/" + extras.getString("KEY");
	...
	private void saveProgram() {
		...
		try {
				is = am.open("Programs/String/" + temp + ".c");
